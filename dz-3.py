...
class Cell:
    def __init__(self, count, stars):
        self.count = count
        self.stars = stars


    def __add__(self, other):
        return Cell(self.count + other.count, self.stars + other.stars)
    ...
    def __sub__(self, other):
        if self.stars - other.stars > 0:
            ...
            print('Колличество ячеек меньше или равно 0. Сделайте корректный ввод!')
    ...
    def make_order(self):
        if self.count % self.stars == 0:
            return print(("*" * self.stars + "\n") * (self.count // self.stars))
        else:
            return print((("*" * self.stars) + "\n") * (self.count // self.stars) + "*" * (self.count % self.stars))
